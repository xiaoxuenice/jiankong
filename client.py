...
while True:
 ...
 try:
    a=requests.get("http://192.168.1.200:8888/receive?host={}&qdsj={}&cpuhs={}&cpulv={}&ncdx={}&nclv={}&cpdx={}&cpsy={}&wkjs={}&wkfs={}&ljs={}&jcs={}".format(host,qdsj,cpuhs,cpulv,ncdx,nclv,cpdx,cpsy,wkjs,wkfs,ljs,jcs),timeout=3).content   #xiaoxue改为监控主机的IP地址
